...
```
读取 data/Nationality/README.md 了解数据和分析目标。在 data/Nationality/out 下产出 R 脚本（out/scripts/01_eda.R 等）、图（out/figs/*.png，300dpi）、analysis.md。严格按 AGENTS.md 的统计纪律，开始任何分析前先读 skills/ 里对应的 skill。数据用FIFA 23 Players。
```
